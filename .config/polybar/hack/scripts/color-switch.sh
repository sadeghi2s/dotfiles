...
<<< "♥ amber|♥ aquamarine|♥ blue|♥ blue-gray|♥ brown|♥ cyan|♥ deep-orange|\
♥ deep-pink|♥ deep-purple|♥ green|♥ gray|♥ indigo|♥ blue-light|♥ green-light|\
♥ lime|♥ orange|♥ pink|♥ purple|♥ red|♥ teal|♥ turquoise|♥ yellow|♥ amber-dark|\
♥ aquamarine-dark|♥ blue-dark|♥ blue-gray-dark|♥ brown-dark|♥ cyan-dark|♥ deep-orange-dark|\
♥ deep-pink-dark|♥ deep-purple-dark|♥ green-dark|♥ gray-dark|♥ indigo-dark|♥ blue-light-dark|\
♥ green-light-dark|♥ lime-dark|♥ orange-dark|♥ pink-dark|♥ purple-dark|♥ red-dark|♥ teal-dark|♥ turquoise-dark|♥ yellow-dark|")"
            case "$MENU" in
				## Light Colors
				*amber) "$SDIR"/colors-light.sh --amber ;;
                *aquamarine) "$SDIR"/colors-light.sh --aquamarine ;;
				...
				*deep-pink) "$SDIR"/colors-light.sh --deep-pink ;;
                ...
                *turquoise) "$SDIR"/colors-light.sh --turquoise;;
				*yellow) "$SDIR"/colors-light.sh --yellow ;;
				## Dark Colors 
				*amber-dark) "$SDIR"/colors-dark.sh --amber ;;
                *aquamarine-dark) "$SDIR"/colors-dark.sh --aquamarine ;;
				...
				*deep-pink-dark) "$SDIR"/colors-dark.sh --deep-pink ;;
                ...
                *turquoise-dark) "$SDIR"/colors-dark.sh --turquoise				
            esac
